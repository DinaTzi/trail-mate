...
This project is indexed by GitNexus as **trail-mate** (52003 symbols, 109576 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
