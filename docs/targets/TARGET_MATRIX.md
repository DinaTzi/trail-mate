...
| `cardputerzero` | real Cardputer Zero framebuffer, evdev, per-page 320 x 170 screenshots from the Pager-derived UI path, notifyd session, Fcitx5 session, launch, and packaging validation | `apps/linux_cardputer_zero + boards/cardputerzero` |
