...
Dashboard, Chat, Compact Map/GPS, Team, Settings.
...
Executable UX pack `cardputer_compact`; current first Linux device-shell slice
uses ASCII renderer until framebuffer ownership is validated.
